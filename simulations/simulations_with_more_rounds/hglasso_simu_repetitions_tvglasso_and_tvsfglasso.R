...
p = 100
n = 100 # Nmb of repetitions, 10, 50, 100
...
for(h in hband){
  ...
  fn = paste0("simulations/simulations_with_more_rounds/results/hglasso/tvglasso_and_tvsfglasso_bandwidth_res/hglasso_mod_", n, "_", p, "_", N, "_", h, ".txt")
