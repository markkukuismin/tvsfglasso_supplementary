...
if(simulator == "liu_ihler"){
  ggsave("simulations/simulations_with_more_rounds/results/figures/liu_ihler_simulator.png",
         plot = boxp,
         dpi = 600,
         width = 10,
         height = 7)
...
if(simulator == "yang_peng"){
  ggsave("simulations/simulations_with_more_rounds/results/figures/yang_peng_simulator.png",
         plot = boxp,
         dpi = 600,
         width = 10,
         height = 7)
...
if(simulator == "huge"){
  ggsave("simulations/simulations_with_more_rounds/results/figures/huge_simulator.png",
         plot = boxp,
         dpi = 600,
         width = 10,
         height = 7)
...
if(simulator == "hglasso"){
  ggsave("simulations/simulations_with_more_rounds/results/figures/hglasso_simulator.png",
         plot = boxp,
         dpi = 600,
         width = 10,
         height = 7)
