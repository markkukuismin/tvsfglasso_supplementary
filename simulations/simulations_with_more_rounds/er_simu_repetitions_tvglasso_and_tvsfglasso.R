...
example <- generate_tv_er_data(p = p, 
                               n = n, 
                               N = N, 
                               e_add_del = e_add_del,
                               cp_step = cp_step,
...
for(h in hband){
  ...
  fn = paste0("simulations/simulations_with_more_rounds/results/er/tvglasso_and_tvsfglasso_bandwidth_res/er_mod_", n, "_", p, "_", N, "_", h, ".txt")
